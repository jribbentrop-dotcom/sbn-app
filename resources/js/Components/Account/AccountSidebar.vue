...
<template>
    <aside class="sbn-account-sidebar">
        ...
        <nav class="sbn-account-nav">
            ...
            <Link href="/account/skills" class="sbn-account-nav-link" :class="{ 'is-active': current === '/account/skills' }">My Skills</Link>
            <Link href="/account/skills/tree" class="sbn-account-nav-link" :class="{ 'is-active': isActive('/account/skills/tree') }">Skill Tree</Link>
