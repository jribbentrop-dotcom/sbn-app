...
/**
 * Assembles a raw Python basic-pitch transcription result into the standard
 * Analysis array (beat→bar grouping, chord region detection, melody
 * reconstruction, tab positioning). Shared by the initial audio import
 * (LeadsheetController::createFromLookup) and every re-derive endpoint
 * (LeadsheetTranscriptionController) since a later re-shift/re-tune/re-detect
 * must reproduce exactly what import did.
 */
trait AssemblesTranscriptions
{
