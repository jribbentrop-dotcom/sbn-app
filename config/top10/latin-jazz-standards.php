...
return [
    'blue-bossa' => [
        ...
        'progressionCaption' => "The <em>minor II-V-I</em> in C minor is the harmonic engine of <em>Blue Bossa</em>. These shell voicings provide a professional jazz sound with minimum movement.",
    ...
    'song-for-my-father' => [
        ...
        'progressionCaption' => "This song has a pretty straightforward chord progression. I particularly like the resolution from the dominant seventh (sus4) chord to the minor tonic.",
        'progressionSlugs' => ['7sus4-shell-roote', 'm7-shell-roota-9'],
        'rhythmName' => 'Trademark Rhythm',
        'rhythmSlug' => 'samba',
    ...
    'night-and-day' => [
        ...
        'progressionName' => 'Key Chords',
        'progressionCaption' => "The minor chord progression resolving to the major tonic is a key sound of <em>Night and Day</em>.",
        'progressionSlugs' => ['maj7-drop3-roote-s11', 'dom7-shell-roote', 'maj7-shell-roota'],
        'rhythmName' => 'Trademark Rhythm',
    ...
    'the-shadow-of-your-smile' => [
        ...
        'progressionName' => 'The Ballad Pair',
        'progressionCaption' => "<strong>Astrud Gilberto's</strong> recording features a wonderful, unusual chord progression in the end that is impossible to ignore!",
        'progressionSlugs' => ['maj7-drop3-roote', 'm7-drop3-roote', 'maj7-drop3-roote'],
        'rhythmName' => 'Trademark Rhythm',
    ...
    'on-green-dolphin-street' => [
        ...
        'progressionName' => 'Key Chords',
        'progressionCaption' => "The modal shift from major to minor is a key progression in many jazz standards. This simple harmonic progression, often stretched out over several bars, lends itself to feature unusual rhythms.",
        'progressionSlugs' => ['maj7-shell-roota', 'm7-shell-roota'],
        'rhythmName' => 'Trademark Rhythm',
    ...
    'swonderful' => [
        ...
        'progressionSlugs' => ['maj7-drop3-roote', 'o7-drop2-roota', 'm7-drop3-roote'],
        'rhythmName' => 'Trademark Rhythm',
        'rhythmSlug' => 'gilberto-rhythm',
    ...
    'watch-what-happens' => [
        ...
        'progressionName' => 'Key Chords',
        'progressionCaption' => "<strong>Michel Legrand's</strong> introduction to this song is unmistakable. The tonic chord is surrounded by two dominant chords, creating a unique and distinctive sound.",
        'progressionSlugs' => ['dom7-shell-roota', 'dom7-shell-roota', 'maj6-shell-roota'],
        'rhythmName' => 'Trademark Rhythm',
        'rhythmSlug' => 'jazz-bossa-nova',
    ...
    'ill-remember-april' => [
        ...
        'progressionName' => 'Key Chords',
        'progressionCaption' => "The distinctive modal shift from major to minor is a key sound of many latin jazz standards.",
        'progressionSlugs' => ['maj7-drop3-roote', 'm7-drop3-roote'],
        'rhythmName' => 'Trademark Rhythm',
    ...
    'love-for-sale' => [
        ...
        'progressionName' => 'Key Chords',
        'progressionCaption' => "<strong>Cole Porter's</strong> harmonic twist is brilliant: the sub-dominant chord resolving to a minor chord on the tonic.",
        'progressionSlugs' => ['maj7-shell-roota', 'm7-drop3-roote'],
        'rhythmName' => 'Trademark Rhythm',
        'rhythmSlug' => 'son-clave-3-2',
