...
return [
    ...
    'desafinado' => [
        ...
        'progressionName' => 'The \"Off-Key\" Pair',
        'progressionCaption' => "The title <em>Desafinado</em> translates to \"Slightly Out of Tune.\" This effect is achieved by the <strong>Secondary Dominant (II7)</strong> equipped with a <strong>#11</strong> (the note C#).",
        'progressionSlugs' => ['maj7-shell-roote', 'dom7-drop3-roote-s11'],
    ...
    'chega-de-saudade' => [
        ...
        'progressionName' => 'The \"Saudade\" Pair',
        'progressionCaption' => "To capture its essence, you need the <strong>Minor 7(9)</strong>. By anchoring your middle finger on the 5th fret (A-string) for the minor chord, and then wrapping your thumb around the 5th fret (E-string) for the dominant, you can cycle through the \"sadness\" and \"tension\" that defines the song without leaving the 5th position.",
        'progressionSlugs' => ['m7-shell-roota-9', 'dom7-shell-roote'],
    ...
    'dindi' => [
        ...
        'progressionName' => 'The Ballad Shift',
        'progressionCaption' => "<em>Dindi</em> requires the emotional depth of the <strong>Major 7th</strong>. By pairing the <strong>Root-6 Maj7</strong> with the <strong>Root-6 Min7</strong>, you can play the main verse progression (I &rarr; ii) just by sliding your hand up 2 frets.",
        'progressionSlugs' => ['maj7-shell-roota', 'maj7-shell-roota'],
